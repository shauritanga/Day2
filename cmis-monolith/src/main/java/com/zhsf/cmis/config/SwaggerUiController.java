...
public class SwaggerUiController {
    ...
    public String swaggerUi() {
        return """
                ...
                <head>
                  <meta charset="utf-8">
                  <title>CMIS Monolith API Docs</title>
                ...
                <body>
                  <div class="cmis-header">
                    <strong>CMIS Monolith API Docs</strong>
                    <div class="cmis-note">Members, claims, adjudications, and legacy hospital endpoints before extraction.</div>
                  </div>
